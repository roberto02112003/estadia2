...
<body>
    ...
    <div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                      ...
                      <a class="nav-link liga" href="myv.php">MISION Y VISION</a>
  ...
  <h1 class="tittle_c">CONTACTO</h1>
  </div>
  <div class="card-body">
    <blockquote class="blockquote mb-0">
    <ul style="list-style: none;">
        <li><img src="img/Redes_sociales/Phone_31105.png" width="30px" > 981-106-6498</li>
        <li><img src="img/Redes_sociales/Phone_31105.png" width="30px" > 981-811-9300</li>
<br>
        <li><img src="img/Redes_sociales/gmail.png" width="30px" > sedumop@campeche.gob.mx</li> 
        <br>
        <li><img src="img/eee.png" width="30px" > Av Patricio Trueba de Regil s/n, San Rafael, 24090 San Francisco de Campeche, Camp.</li>
    </ul>
